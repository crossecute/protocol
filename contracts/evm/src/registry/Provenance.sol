...
///      which outlives the bytecode that wrote it. After a deployment that is not an enum
///      edit but a migration that silently restates every configured chain. Append, or
